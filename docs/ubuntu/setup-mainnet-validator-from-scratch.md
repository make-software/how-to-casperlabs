...
For this upgrade, to `casper-node v1.4.5`, the activation point is `Era 4416`. You have to make sure you have properly staged the upgrade well ahead of the activation point, so that your node will be upgraded on time.
