...
Go to [Clarity](https://clarity-testnet.make.services/#/accounts) and login using your GitHub or Google account. Click the "Import Key" button and select your public key file ```public_key.pem```. Do NOT, EVER, upload your private key. Give it a name and hit "Save".  
